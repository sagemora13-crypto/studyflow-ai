...
public enum TenxProject {
  public static let projectAPIURL = resolvedURL(
    "TENX_PROJECT_API_URL", fallback: "https://prj-7def2cc9aa054396.api.10x.app")
  public static let authBaseURL = resolvedURL(
    "TENX_AUTH_BASE_URL", fallback: "https://prj-7def2cc9aa054396.api.10x.app/auth")
  public static let storageBaseURL = resolvedURL(
    "TENX_STORAGE_BASE_URL", fallback: "https://prj-7def2cc9aa054396.api.10x.app/storage")
  public static let requestTimeoutInterval: TimeInterval = 20
  public static let dataAPIURL: URL? = resolvedOptionalURL(
    "TENX_DATA_API_URL",
    fallback: "https://ep-floral-hill-atgk3yg5.apirest.c-9.us-east-1.aws.neon.tech/neondb/rest/v1")
  public static let jwksURL: URL? = URL(
    string:
      "https://tenx-managed-better-auth.onrender.com/.well-known/apps/prj-7def2cc9aa054396/jwks.json"
  )
  ...
  public static let generatedClientHash: String? =
    "84142dd9a8a5bbde093624e3161e00f094a8953b7a760c1e37698335dc515ccb"
  ...
  private static func overrideValue(_ key: String) -> String? {
    if let value = ProcessInfo.processInfo.environment[key]?.trimmingCharacters(
...
extension KeyedDecodingContainer where Key == TenxFlexibleCodingKey {
  func decodeString(_ key: String, _ fallbackKey: String? = nil, defaultValue: String? = nil) throws
    -> String
  {
  ...
  func decodeInt(_ key: String, _ fallbackKey: String? = nil, defaultValue: Int? = nil) throws
    -> Int
  {
  ...
  func decodeValue<T: Decodable>(_ type: T.Type, _ key: String, _ fallbackKey: String? = nil) throws
    -> T
  {
  ...
  func decodeOptionalValue<T: Decodable>(
    _ type: T.Type, _ key: String, _ fallbackKey: String? = nil
  ) throws -> T? {
    if let value = try decodeIfPresent(type, forKey: TenxFlexibleCodingKey(key)) {
      return value
    }
...
public struct TenxAppleFullName: Codable, Sendable {
  ...
  public init(
    givenName: String? = nil, familyName: String? = nil, middleName: String? = nil,
    nickname: String? = nil
  ) {
...
extension URLSession {
  ...
  func tenxData(for request: URLRequest, retryingTransientJWKMiss: Bool = false) async throws
    -> Data
  {
    var request = request
    request.timeoutInterval = TenxProject.requestTimeoutInterval
  ...
  private static func tenxBackendError(statusCode: Int, data: Data) -> TenxBackendError {
    ...
    let message =
      tenxString(object, keys: ["message", "error_description", "error", "detail"])
    ...
    if isTenxServicePaused(statusCode: statusCode, object: object) {
      let state = TenxServicePaused(
        ...
        reason: tenxString(
          object,
          keys: ["paused_reason", "pausedReason", "reason", "cap_status", "capStatus", "code"]),
  ...
  private static func isTenxServicePaused(statusCode: Int, object: [String: Any]) -> Bool {
    ...
    .joined(separator: " ")
    if markers.contains("paused") || markers.contains("pause") || markers.contains("cap_reached")
      || markers.contains("spend_cap")
    {
      return true
    }
