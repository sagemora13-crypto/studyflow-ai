...
struct DeckReviewView: View {
        ...
        HStack(spacing: 10) {
            ForEach(RecallGrade.allCases) { grade in
                Button {
                    ...
                    .padding(.vertical, 12)
                    .background(gradeColor(grade).opacity(0.18), in: RoundedRectangle(cornerRadius: Theme.radiusMedium, style: .continuous))
    ...
    private var sessionSummary: some View {
        VStack(spacing: 16) {
            ...
            if deck.cards.isEmpty {
                ...
                Text(reviewed > 0 ? "They'll come back exactly when you're about to forget them." : "Come back later — your next reviews are scheduled.")
    ...
    private func resetCardFields() {
        front = ""; back = ""; showingAddCard = false
    }
}
