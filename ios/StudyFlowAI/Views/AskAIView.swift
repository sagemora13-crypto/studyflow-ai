...
struct AskAIView: View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            if !reply.generatedCards.isEmpty {
                Button {
                    ...
                    Label("Add \(reply.generatedCards.count) cards to a deck", systemImage: "plus.rectangle.on.rectangle")
    ...
    private var hint: some View {
        EmptyStateView(
            ...
            message: "Type a question, then pick how you want help — a hint, a full walkthrough, or a check of your own answer."
        )
    }
