...
final class QuizResult {
    ...
    init(topic: String, subject: String, scorePercent: Int, totalQuestions: Int, correctCount: Int, weakTopics: [String] = []) {
        self.topic = topic
...
final class StudyGuide {
    ...
    init(title: String, subject: String, mainIdeas: [String] = [], vocabulary: [String] = [], formulas: [String] = [], sampleQuestions: [String] = []) {
        self.title = title
        self.subject = subject
